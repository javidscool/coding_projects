...
struct FlickrAPI{
    ...
    static func photos(fromJSON data: Data,
        ...
        do {
            ...
            if finalPhotos.isEmpty && !photosArray.isEmpty {
                ...
                //even though the JSON was there
    ...
    //getting a single photo from JSON data
    private static func photo(fromJSON json: [String:Any],
        ...
        //check if we already have a photo, return the existing photo if we've got it
        ...
        //if not, create a new photo and return it
        //when we create a photo here, we're inserting it into the context
        var photo: Photo!
        context.performAndWait {
