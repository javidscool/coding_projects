...
Lightmap::Lightmap(std::vector<Object> objList, std::vector<Eigen::Matrix4f> modelViews)
{
...
Triangle Lightmap::ConvertToCamera(Triangle tri, Eigen::Matrix4f modelview)
{
...
Triangle Lightmap::ConvertNormToCamera(Triangle tri, Eigen::Matrix4f modelview)
{
    Eigen::Matrix<float, 4, 1> trans;
    Eigen::Matrix<float, 4, 1> ans;
...
Color Lightmap::GetColor(Object curObj, float v, float u, Triangle hitTri)
{
    //log << "u: " << u << endl;
    //log << "v: " << v << endl;
