...
ShooterCamera::ShooterCamera(se::graphics::gl::PCGLWindow& win):window(win), phi(0.0), theta(0.0), position(se::math::Vector3D(0,0,0)),zpass(true), showvolumes(false)
{
...
//    bindButtonDown(PCInputBinding::ESCAPE, ShooterCamera::escape);
    ...
    bindButtonDown('z', boost::bind(&ShooterCamera::zPressed, this));
    bindButtonDown('v', boost::bind(&ShooterCamera::vPressed, this));
