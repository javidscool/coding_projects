...
void TravSMan::Generation(){
	...
	//Evaluate past 5 gnerations to determine if Hypermutation is necessary
	...
	while (vecNewPop.size() != popSize){
		...
		//perform mutation
		InsertionMutation(child1.vecCities, variableMutationRate);
		InsertionMutation(child2.vecCities, variableMutationRate);
