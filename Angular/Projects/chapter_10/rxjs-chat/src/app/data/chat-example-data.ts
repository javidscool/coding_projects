...
export class ChatExampleData {
	...
	static setupBots(messagesService: MessagesService): void {
		...
		//echo bot
		//set up a stream subscription where for every message emitted on the tEcho thread that does not belong to
		//the echo bot will emit a new message that just copies the message of the user, and attributes it to the echo bot
		...
		//reverse bot
		//set up a stream subscription where for every message emitted on the tRev thread that does not belong to
		//the rev bot will emit a new message that reverses the message of the user, and attributes it to the rev bot
		...
		//waiting bot
		//set up a stream subscription where for every message emitted on the tWait thread that does not belong to
		//the wait bot will emit a new message that just wait a certain number of seconds the user entered
		//and prints out a message using the time waited and attributes it to the wait bot
